...
local ____modifier_item_crown_of_insight = require("modifiers.modifier_item_crown_of_insight")
local modidifier_item_crown_of_insight = ____modifier_item_crown_of_insight.modidifier_item_crown_of_insight
____exports.item_crown_of_insight = __TS__Class()
local item_crown_of_insight = ____exports.item_crown_of_insight
item_crown_of_insight.name = "item_crown_of_insight"
__TS__ClassExtends(item_crown_of_insight, BaseItem)
function item_crown_of_insight.prototype.GetIntrinsicModifierName(self)
    return modidifier_item_crown_of_insight.name
end
function item_crown_of_insight.prototype.OnOwnerSpawned(self)
    local required_level = self:GetSpecialValueFor("required_level")
    local gear_type = self:GetSpecialValueFor("gear_type")
end
function item_crown_of_insight.prototype.OnHeroLevelUp(self)
    if IsServer() then
        local required_level = self:GetSpecialValueFor("required_level")
        local gear_type = self:GetSpecialValueFor("gear_type")
...
function item_crown_of_insight.prototype.CanUnitPickUp(self, unit)
    local required_level = self:GetSpecialValueFor("required_level")
    local gear_type = self:GetSpecialValueFor("gear_type")
...
item_crown_of_insight = __TS__Decorate(
    {
        registerAbility(nil)
    },
    item_crown_of_insight
)
return ____exports
